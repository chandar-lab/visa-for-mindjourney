        ...
        for question in self.questions:
            ...
            for step in range(self.model_args.max_steps_per_question):
                ...
                for rank_i in range(2):
                    ...
                    if rank_i == 1:
                        ...
                        if self.model_args.use_top_k_filtering:
                            ...
                            shuffled_scores = top_scores_all[rank_i]
                            random.shuffle(shuffled_scores)
                            filtered_scores = shuffled_scores[:top_k]
                        else:
                ...
                if self.model_args.use_top_k_filtering:
                    ...
                    shuffled_scores = top_scores_all[0]
                    random.shuffle(shuffled_scores)
                    filtered_exploration_scores = shuffled_scores[:min(top_k, self.model_args.num_beams)]
                else:
