...
class Keyframe(object):
    ...
    override_transition_sec: Union[float, None]
...
class CameraTrajectory(object):
    def __init__(
        ...
        self._camera_edit_panel: Union[viser.Gui3dContainerHandle, None] = None

        self._orientation_spline: Union[splines.quaternion.KochanekBartels, None] = None
        self._position_spline: Union[splines.KochanekBartels, None] = None
        self._fov_spline: Union[splines.KochanekBartels, None] = None
    ...
    def add_camera(self, keyframe: Keyframe, keyframe_index: Union[int, None] = None) -> None:
...
class GuiState:
    ...
    camera_traj_list: Union[list, None]
...
def define_gui(
    ...
    **kwargs,
    ...
    def add_preview_frame_slider() -> Union[viser.GuiInputHandle[int], None]:
    ...
    preview_camera_handle: Union[viser.SceneNodeHandle, None] = None
    ...
    def compute_and_update_preview_camera_state() -> Union[tuple[vt.SE3, float], None]:
