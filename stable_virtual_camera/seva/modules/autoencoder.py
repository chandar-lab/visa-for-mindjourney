...
class AutoEncoder(nn.Module):
    ...
    def __init__(self, chunk_size: Union[int, None] = None):
        super().__init__()
    ...
    def encode(self, x: torch.Tensor, chunk_size: Union[int, None] = None) -> torch.Tensor:
    ...
    def decode(self, z: torch.Tensor, chunk_size: Union[int, None] = None) -> torch.Tensor:
        chunk_size = chunk_size or self.chunk_size
        if chunk_size is not None:
            return torch.cat(
