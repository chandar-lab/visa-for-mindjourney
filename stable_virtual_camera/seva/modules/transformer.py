...
class Attention(nn.Module):
    ...
    def forward(
        ...
        # Try different attention backends in order of preference
        try:
            # First try Flash Attention (for newer GPUs)
            ...
            try:
                ...
                print("Warning: Using manual attention implementation due to SDPA kernel issues")
    ...
    def _manual_attention(self, q, k, v):
        """Manual attention implementation as fallback when SDPA kernels fail."""
